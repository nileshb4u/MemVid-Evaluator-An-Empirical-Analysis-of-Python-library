...
![Comparison of Actual Storage Sizes for different text types using MemVid with the mp4v codec, showing original text size, gzipped text size, and total MemVid storage size.](assets/mp4_Comparison of Actual Storage Sizes.jpg)
